...
class sbc4_zhpreprocess(luigi.Task):
    ...
    def output(self):
        return luigi.LocalTarget('data/sbc4/sbc4.zhpreprcs.txt')
...
sbc4_zhpreprocess_slash = gentask.transformat_line2slash(
    'sbc4_zhpreprocess_slash', sbc4_zhpreprocess(), 'data/sbc4/sbc4.zhpreprcs.slash.txt')

sbc4_zh_to_tok_tag_phrasetable = gentask.phrasetable(
    'sbc4_zh_to_tok_tag_phrasetable', sbc4_zhpreprocess(), 'data/sbc4/sbc4.zh2toktag.phrasetable.h5')
